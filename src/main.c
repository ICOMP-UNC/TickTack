...
int main(void)
{
    ...
    xTaskCreate(vRead_RTC_Time_task, "ReadRTC", configMINIMAL_STACK_SIZE, NULL, configMAX_PRIORITIES - 1,
                &Handle_read_rtc);
    xTaskCreate(vDraw_DISPLAY_task, "DrawDisplay", configMINIMAL_STACK_SIZE, NULL, configMAX_PRIORITIES,
                &Handle_draw_display);
